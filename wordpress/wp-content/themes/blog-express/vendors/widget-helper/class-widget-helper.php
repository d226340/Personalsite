...
if ( ! class_exists( 'Blog_Express_Widget_Helper' ) ) {
	 ...
	 * @version 1.0.1
	 */
	class Blog_Express_Widget_Helper extends WP_Widget {
			...
			switch ( $type ) {
				...
				case 'image':
					...
					<div class="widget-field-image">
						<label for="<?php echo esc_attr( $this->get_field_id( $key ) ); ?>"><?php echo esc_html( $field['label'] ); ?></label>
						<input type="button" class="button button-primary wh-image-picker" value="<?php esc_attr_e( 'Upload', 'blog-express' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'blog-express' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'blog-express' ); ?>" />
						...
						<input type="button" class="button button-secondary btn-image-remove" value="<?php esc_attr_e( 'Remove', 'blog-express' ); ?>" <?php echo ( empty( $value ) ) ? 'style="display:none;"' : ''; ?> />
