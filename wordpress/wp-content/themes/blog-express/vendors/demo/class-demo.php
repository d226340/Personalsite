...
if ( ! class_exists( 'Blog_Express_Demo' ) ) {
	 ...
	 * @version 1.0.2
	 */
	class Blog_Express_Demo {

		/**
		 * Singleton instance of Blog_Express_Demo.
		 *
		 * @var Blog_Express_Demo $instance Blog_Express_Demo instance.
		 */
		...
		/**
		 * Main Blog_Express_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Blog_Express_Demo ) ) {
				self::$instance = new Blog_Express_Demo();
